  ...
  return (
    <form onSubmit={handleSubmit} className="public-panel w-full max-w-md rounded-3xl border border-slate-200 p-7 sm:p-8">
      <div>
        ...
        <p className="mt-6 text-xs font-bold uppercase tracking-[0.18em] text-teal-700">Secure workspace</p>
        <h1 className="mt-2 text-2xl font-extrabold tracking-tight text-slate-950">Official sign in</h1>
        <p className="mt-2 text-sm leading-6 text-slate-600">Access report management, assignment, and public progress updates.</p>
      </div>
